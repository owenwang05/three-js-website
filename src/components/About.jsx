...
const ServiceCard = ({index, title, icon}) => {
  return(
    <Tilt className="xs:w-[250px] xxl:w-[350px] w-full">{/* you can remove the flex here */}
      <motion.div
      ...
      >
        <div
          ...
          className="bg-tertiary rounded-[20px] py-5 px-12 xxl:py-8 xxl:px-18 min-h-[280px] xxl:min-h-[350px] flex flex-col items-center justify-evenly"
        >
