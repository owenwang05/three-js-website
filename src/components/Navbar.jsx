...
const Navbar = () => {
  ...
  return (
    <motion.nav variants={container(0, 0.8)} initial="hidden" animate="show" className={`${styles.paddingX} w-full flex items-center py-5 xxl:py-6 fixed top-0 z-20 backdrop-filter backdrop-blur-lg border-b border-[#162435]`}>
      <div className="w-full flex justify-between items-center max-w-7xl xxl:max-w-[1536px] mx-auto">
        ...
        >
          <motion.img variants={item(25, "neg")} src={logo} alt="logo" className="w-9 h-9 xxl:w-12 xxl:h-12 object-cover rounded-full"/>
          <motion.p variants={item(25, "neg")} className="text-white text-lg xxl:text-[24px] font-bold cursor-pointer">
            Owen Wang
          </motion.p>
        </Link>
